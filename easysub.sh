...
echo "	"
echo "	"
	echo -e "\e[33m[Usage:] $ ./easysub.sh domain.com\e[0m"
	echo -e "\e[33m FLAG : -------------------------------------------------------------\e[0m"
	echo -e "\e[33m           -h : Help , Print This Message\e[0m"
	echo -e "\e[33m           -s : Silent output - No banner, no progress, only domains\e[0m"
}
if [ $# -eq 0 ] || [ "$1" = "-h" ]
  then
    usage
